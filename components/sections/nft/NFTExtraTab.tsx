...
export const NFTExtraTab = ({ isActive }: { isActive: boolean }) => {
    ...
    return(
        <NFTTab isActive={isActive}>
            <div className="text-black text-lg lg:text-2xl text-center md:text-left font-light lg:font-extralight my-auto xl:mb-0 lg:mb-auto">
                ...
                <div className="bg-black-blob mt-16 lg:px-3/20 lg:pt-16 pb-28 xl:pb-60 relative">
                    ...
                    <img className="inline-block w-40 lg:w-64 h-40 lg:h-64 object-cover border-2 border-dashed border-neutral-300 rounded-3xl md:float-left mr-4 mb-4" src="/img/Origin.png" alt="Initial Cow Illustration" />
