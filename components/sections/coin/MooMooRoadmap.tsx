        ...
        <div className="relative mt-6 mb-8">
            ...
            <div className="flex justify-between gap-8 overflow-x-auto">
                <div className="w-1/3 sm:w-1/5 flex flex-col items-center shrink-0">
                    ...
                    <h5 className="text-base lg:text-md mt-2 text-black">ICO Announcement</h5>
                </div>
                ...
                <div className="w-1/3 sm:w-1/5 flex flex-col items-center shrink-0">
                    ...
                    <h5 className="text-base lg:text-md mt-2 text-black">Airdrop to Whitelist and Top Rarity NFT Holders</h5>
                </div>
                ...
                <div className="w-1/3 sm:w-1/5 flex flex-col items-center shrink-0">
                    ...
                    <h5 className="text-base lg:text-md mt-2 text-black">Airdrop Raffles</h5>
                </div>
                ...
                <div className="w-1/3 sm:w-1/5 flex flex-col items-center shrink-0">
                    ...
                    <h5 className="text-base lg:text-md mt-2 text-black">Listing on Exchanges</h5>
                </div>
            </div>
