...
export const EmailForm = () => {
    ...
    return(
        <form className="relative" onSubmit={handleSubmit}>
            ...
            <small className="block text-sm text-dark-green-light text-justify p-1">This site is protected by reCAPTCHA and the Google <a className="text-white opacity-50" href="https://policies.google.com/privacy">Privacy Policy</a> and <a className="text-white opacity-50" href="https://policies.google.com/terms">Terms of Service</a> apply.</small>
