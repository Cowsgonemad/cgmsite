    ...
    return(
        <GameTab isActive={isActive}>
            <div className="shrink-0 relative w-full lg:w-1/3">
                ...
                <img className="block absolute top-0 left-0 size-full object-cover object-center scale-95" src="https://i.blogs.es/f7edf0/fortnite/1366_2000.jpeg" alt="Cover Art" />
