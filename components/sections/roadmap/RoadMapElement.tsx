import { RoadmapBg1, RoadmapBg2 } from '.';
...
export const RoadMapElement = ({
    ...
    const odd = 'absolute top-0 left-3/20 px-1/10 pt-1/20';
    const even = 'absolute top-3/20 px-1/10 pt-1/20';

    return(
        <div className="2xl:w-1/4 xl:w-1/3 md:w-1/2 sm:w-full w-full shrink-0 relative p-2">

            {type === 'odd' ? <RoadmapBg1 /> : <div className="translate-x-4 translate-y-16"><RoadmapBg2 /></div>}
